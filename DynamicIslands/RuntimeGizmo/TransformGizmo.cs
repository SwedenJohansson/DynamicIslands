...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
		...
		public KeyCode DeleteSelected = KeyCode.Delete;
		...
		void SetMaterial()
		{
			if(lineMaterial == null)
			{
				...
				lineMaterial = new Material(DynamicIslands.DynamicIslands._shaders[0]);
				outlineMaterial = new Material(DynamicIslands.DynamicIslands._shaders[1]);
			}
		}
	}
}
